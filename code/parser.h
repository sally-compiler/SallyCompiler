...
#define TYPE_NEW(TYPE_INFO) ((temp_type = (Type_Info*)(new TYPE_INFO)),\
                            (Type_Info *)temp_type)
...
struct Parser {
    ...
    Ast_Block *parse_block(Ast_Block *parent_block, bool32 is_procedure_block = false, Ast_Block *new_block = NULL);
    ...
    Ast_Declaration_List *parse_declaration(Ast_Block *scope = NULL, Array<Ast_Declaration *> *decls = NULL);
...
Ast_Declaration *find_declaration(Ast_Block *block, const char *name, Array<Ast_Declaration *> *globals = NULL);
