...
template <typename T> void Array<T>::grow(size_t addlen, size_t min_cap) {
 ...
 */
template <typename T> Array<Array<T>> make_2d(int row, int column = -1) {
